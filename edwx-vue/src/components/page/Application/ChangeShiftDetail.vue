    ...
    <div class="changeshift-detail">
        ...
        <div class="detail-info">
            <group class="apply-boxs">
                ...
                <cell title="调班日期" value-align="left" :value="apply.tbrq"></cell>
                <cell title="原班次" value-align="left" :value="apply.ybc"></cell>
                <cell title="新班次" value-align="left" :value="apply.xbc"></cell>
    ...
    export default {
        ...
        methods: {
            ...
            getChangeShiftDetail() {
                ...
                this.$api.ChangeShift.getChangeShiftDetail({
                    xh: this.xh,
            ...
            onOperate() {
                this.$utils.Tools.loadShow();
                this.$api.ChangeShift.approvalChangeShift({
            ...
            onConfirm() {
                this.$utils.Tools.loadShow();
                this.$api.ChangeShift.deleteChangeShift(this.xh, this.$utils.Store.getItem('userSerial'), '').then(response => {
                        this.$utils.Tools.loadHide();
                        const {code, msg, data} = response;
                        if (+code !== this.$code.success) {
                            this.$utils.Tools.toastShow(msg);
